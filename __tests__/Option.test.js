...
describe('Option', () => {
  it('should render correctly with all props, with color as string', () => {
    const component = shallow(<Option {...mockGameConfig} color={mockGameConfig.colorString} onClick={mockClickFn} />)
  
    expect(component).toMatchSnapshot()
  })

  it('should render correctly with all props, with color as array', () => {
    const component = shallow(<Option {...mockGameConfig} color={mockGameConfig.colorArray} onClick={mockClickFn} />)
  ...
  it('should throw error if prop "name" is below min length', () => {
    expect(() => shallow(<Option {...mockGameConfig} name={"a"} onClick={mockClickFn} />)).toThrow()
  })
  ...
  it('should throw error if prop "color" is not present', () => {
    expect(() => shallow(<Option {...mockGameConfig} color={undefined} onClick={mockClickFn} />)).toThrow()
  })

  it('should throw error if prop "color" is not a string or string[]', () => {
    expect(() => shallow(<Option {...mockGameConfig} color={1} onClick={mockClickFn} />)).toThrow()
  })

  it('should throw error if prop "color" is not valid', () => {
    expect(() => shallow(<Option {...mockGameConfig} color={mockInvalidColor} onClick={mockClickFn} />)).toThrow()
  })
